...
class EmailAddress(models.Model):
    ...
    verified = models.BooleanField(verbose_name=_('تایید شده'), default=False)
    primary = models.BooleanField(verbose_name=_('اولبه'), default=False)

    objects = EmailAddressManager()

    class Meta:
        verbose_name = _("آدرس ایمیل")
        verbose_name_plural = _("آدرس های ایمیل")
...
class EmailConfirmation(models.Model):
    ...
    email_address = models.ForeignKey(EmailAddress,
                                      verbose_name=_('آدرس ایمیل'),
                                      on_delete=models.CASCADE)
    created = jmodels.jDateTimeField(verbose_name=_('ایجاد شده در'),
                                   default=timezone.now)
    sent = jmodels.jDateTimeField(verbose_name=_('فرستاده شده'), null=True)
    key = models.CharField(verbose_name=_('کلید'), max_length=64, unique=True)

    objects = EmailConfirmationManager()

    class Meta:
        verbose_name = _("تاییدیه ی ایمیل")
        verbose_name_plural = _("تاییده های ایمیل")
